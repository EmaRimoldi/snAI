...
export function useReasonTexts(): Record<ReviewReasonCode, string> {
  ...
  return {
    ...
    BENEFIT_LETTER_EXPIRED: c.rc_BENEFIT_LETTER_EXPIRED,
    PAY_STUB_EXPIRED: c.rc_PAY_STUB_EXPIRED,
    GIG_STATEMENT_EXPIRED: c.rc_GIG_STATEMENT_EXPIRED,
    EMPLOYMENT_RATE_CONFLICT: c.rc_EMPLOYMENT_RATE_CONFLICT,
    MISSING_HOUSEHOLD_SIZE: c.rc_MISSING_HOUSEHOLD_SIZE,
    MISSING_INCOME_EVIDENCE: c.rc_MISSING_INCOME_EVIDENCE,
    NO_FROZEN_THRESHOLD: c.rc_NO_FROZEN_THRESHOLD,
    UNVERIFIED_INCOME_CLAIM: c.rc_UNVERIFIED_INCOME_CLAIM,
...
export function useReasonTitles(): Record<ReviewReasonCode, string> {
  ...
  return {
    ...
    BENEFIT_LETTER_EXPIRED: c.rcTitle_BENEFIT_LETTER_EXPIRED,
    PAY_STUB_EXPIRED: c.rcTitle_PAY_STUB_EXPIRED,
    GIG_STATEMENT_EXPIRED: c.rcTitle_GIG_STATEMENT_EXPIRED,
    EMPLOYMENT_RATE_CONFLICT: c.rcTitle_EMPLOYMENT_RATE_CONFLICT,
    MISSING_HOUSEHOLD_SIZE: c.rcTitle_MISSING_HOUSEHOLD_SIZE,
    MISSING_INCOME_EVIDENCE: c.rcTitle_MISSING_INCOME_EVIDENCE,
    NO_FROZEN_THRESHOLD: c.rcTitle_NO_FROZEN_THRESHOLD,
    UNVERIFIED_INCOME_CLAIM: c.rcTitle_UNVERIFIED_INCOME_CLAIM,
