...
// Exact TypeScript representation of
// engine/tests/fixtures/rules/rule_corpus.jsonl. The parity test prevents this
// deployable copy from drifting from the engine's frozen source of truth.
export const RULE_CORPUS_VERSION = "rule-corpus-de812149b6696caf";

export const TRUSTED_RULES: readonly TrustedRule[] = [
  {
